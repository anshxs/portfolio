  ...
  return (
    <header className="w-full flex justify-between items-center py-2 px-3 md:px-8 md:fixed md:z-20 bg-transparent">
      ...
      <div className="flex items-center gap-2">
        <div
          className="flex items-center p-2 font-bold cursor-pointer rounded-md bg-gray-100"
          onClick={() => {
            router.push("https://github.com/anshxs");
          }}
        >
          <Github size={12} fill="black" className="hover:animate-spin" />
        </div>
        <span onClick={() => {
          router.push("https://instagram.com/ansh_xs");
        }} className="inline-block cursor-pointer w-7 h-7 bg-gray-100 rounded-md p-[5px]">
          <svg
            viewBox="0 0 24 24"
            className="w-full h-full fill-transparent stroke-[3]"
          >
            <defs>
              <linearGradient
                id="instaGradient"
      ...
      <div className="flex items-center gap-2 text-xs font-medium uppercase text-gray-800">
        ...
        <div
          ...
          className="flex md:hidden items-center px-2 py-1 rounded-md bg-gray-100"
        >
          <MapPin size={12} />
          India (UTC+5:30)
        </div>
        ...
        <div
          style={{ fontFamily: "marlin" }}
          className="hidden md:flex items-center px-2 py-1 gap-1 rounded-md bg-gray-100"
        >
          <MapPin size={12} />
          India
        </div>
